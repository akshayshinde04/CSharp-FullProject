...
namespace Casestudy
{
    class Program
    {
        ...
        public static void scenario1_Student()
        {
            ...
            Student s1 = new Student(101, "Akshay", "05/ 02 / 2003");
            i1.display(s1);
            Student s2 = new Student(102, "Rahul", "01 / 02 / 1998");
            i1.display(s2);
            Student s3 = new Student(103, "Ram", "12 / 07 / 1996");
            i1.display(s3);
            Student s4 = new Student(104, "Sham", " 17 / 05 / 1999");
            i1.display(s4);
            Student s5 = new Student(105, "Anjali", " 18 / 08 / 1999");
            i1.display(s5);
        }
        ...
        public static void scenario2_Student()
        {
            ...
            student[0] = new Student(106, "Sachin", "04/05/2000");
            student[1] = new Student(107, "Raaj", "06/05/1999");
            student[2] = new Student(108, "Prasad", "08/04/2004");
            student[3] = new Student(109, "Gaurav", "03/02/2005");
            student[4] = new Student(110, "Ajay", "01/09/2006");
        ...
        public static void scenario1_Course()
        {
            ...
            i2.display(c2);
            Course c3 = new Course(203, "C Lang", 45, 35000);
            i2.display(c3);
            Course c4 = new Course(204, "Salesforce", 70, 25000);
            i2.display(c4);
        }
